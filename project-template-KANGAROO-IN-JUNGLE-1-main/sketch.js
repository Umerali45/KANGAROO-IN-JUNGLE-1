...
//find the bug in the below code
    ...
    //find the bug in the below code
    switch(rand) {
      case 1: shrub.addImage("shrub1", shrub1_img);
      case 2: shrub.addImage("shrub2", shrub2_img);
      case 3: shrub.addImage("shrub3", shrub3_img);
      default: break;
    }
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
    ...
    var obstacle = createSprite(camera.position+500,330,40,10);
